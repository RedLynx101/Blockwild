...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1848: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_916: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_916_2: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_916_3: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1862: (a: number, b: number, c: number, d: number) => void;
