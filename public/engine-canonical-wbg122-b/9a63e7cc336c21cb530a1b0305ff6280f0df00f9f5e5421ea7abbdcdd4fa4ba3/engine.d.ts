...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1853: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_917: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_917_2: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_917_3: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1871: (a: number, b: number, c: number, d: number) => void;
