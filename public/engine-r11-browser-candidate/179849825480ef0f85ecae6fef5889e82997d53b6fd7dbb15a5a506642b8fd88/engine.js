 ...
 * @param {Uint8Array} expected_prior_checkpoint_bytes
 * @returns {Uint8Array}
 */
export function blockwild_runtime_finalize_historical_external_save_v2(handle, control_bytes, proposal_bytes, expected_prior_checkpoint_bytes) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(control_bytes, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        ...
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArray8ToWasm0(expected_prior_checkpoint_bytes, wasm.__wbindgen_export);
        const len2 = WASM_VECTOR_LEN;
        wasm.blockwild_runtime_finalize_historical_external_save_v2(retptr, handle, ptr0, len0, ptr1, len1, ptr2, len2);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
 ...
 * @returns {Uint8Array}
 */
export function blockwild_runtime_hydrate_historical_external_v2(handle, control_bytes) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(control_bytes, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        wasm.blockwild_runtime_hydrate_historical_external_v2(retptr, handle, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var v2 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_export2(r0, r1 * 1, 1);
 ...
 * @returns {Uint8Array}
 */
export function blockwild_runtime_migrate_historical_external_v2(handle, control_bytes, proposal_bytes, world_projection_bytes) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(control_bytes, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(proposal_bytes, wasm.__wbindgen_export);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArray8ToWasm0(world_projection_bytes, wasm.__wbindgen_export);
        const len2 = WASM_VECTOR_LEN;
        wasm.blockwild_runtime_migrate_historical_external_v2(retptr, handle, ptr0, len0, ptr1, len1, ptr2, len2);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var v4 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_export2(r0, r1 * 1, 1);
...
export function blockwild_runtime_migrate_legacy_v2(handle, control_bytes, legacy_non_world_state_flags, source_key, source_format, world_projection_bytes) {
    try {
        ...
        const ptr0 = passArray8ToWasm0(control_bytes, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(source_key, wasm.__wbindgen_export, wasm.__wbindgen_export3);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(source_format, wasm.__wbindgen_export, wasm.__wbindgen_export3);
        const len2 = WASM_VECTOR_LEN;
 ...
 * @param {number} handle
 * @param {Uint8Array} control_bytes
 * @param {Uint8Array} observation_bytes
 * @returns {Uint8Array}
 */
export function blockwild_runtime_reconcile_historical_external_fallback_v2(handle, control_bytes, observation_bytes) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(control_bytes, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(observation_bytes, wasm.__wbindgen_export);
        const len1 = WASM_VECTOR_LEN;
        wasm.blockwild_runtime_reconcile_historical_external_fallback_v2(retptr, handle, ptr0, len0, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var v3 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_export2(r0, r1 * 1, 1);
