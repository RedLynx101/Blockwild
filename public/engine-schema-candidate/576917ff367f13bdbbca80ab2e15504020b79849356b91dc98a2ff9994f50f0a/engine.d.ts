 ...
 */
export function blockwild_runtime_finalize_historical_external_save_v2(handle: number, control_bytes: Uint8Array, proposal_bytes: Uint8Array, expected_prior_checkpoint_bytes: Uint8Array): Uint8Array;
 ...
 */
export function blockwild_runtime_hydrate_historical_external_v2(handle: number, control_bytes: Uint8Array): Uint8Array;
 ...
 */
export function blockwild_runtime_migrate_historical_external_v2(handle: number, control_bytes: Uint8Array, proposal_bytes: Uint8Array, world_projection_bytes: Uint8Array): Uint8Array;
 ...
 */
export function blockwild_runtime_reconcile_historical_external_fallback_v2(handle: number, control_bytes: Uint8Array, observation_bytes: Uint8Array): Uint8Array;
...
export interface InitOutput {
    ...
    readonly blockwild_runtime_finalize_historical_external_save_v2: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
    readonly blockwild_runtime_hydrate_historical_external_v2: (a: number, b: number, c: number, d: number) => void;
    readonly blockwild_runtime_initialize_native_save_v2: (a: number, b: number, c: number, d: number) => void;
    readonly blockwild_runtime_migrate_historical_external_v2: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
    ...
    readonly blockwild_runtime_reconcile_historical_external_fallback_v2: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
